...
subtitle: "2024 Workshop on Genomics, Cesky Krumlov"
author: "RA Steward"
...
keep <- rowSums(counts(Pcal_dds) >= 5 ) >= 9
...
Estimate the size factors for each sample:
...
When using unsupervised clustering methods, transformation of the normalized counts improves the estimated correlations or distances between samples or genes for visualization. `DESeq2` recommends a variance-stabilizing transformation (`vst()`) of the normalized counts.
